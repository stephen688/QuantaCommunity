...
type AuthBadgeTone = 'success' | 'warning' | 'danger' | 'neutral';
...
Component({
  properties: {
    ...
    user: {
      type: Object,
      value: undefined as unknown as UserInfoVO | undefined,
    },
    errorType: {
      type: String,
      value: '',
    ...
    authBadgeTone: {
      type: String,
      value: 'neutral' as AuthBadgeTone,
    },
    identityTypeText: {
      type: String,
      value: '',
  ...
  methods: {
    applyUser() {
      const u = this.data.user as UserInfoVO | undefined;
      const name =
