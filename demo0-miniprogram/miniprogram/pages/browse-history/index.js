...
Page({
    ...
    async onClearTap() {
        ...
        const res = await (0, user_content_service_1.clearBrowseHistory)();
    ...
    async loadFirstPage(fromRefresh = false) {
        ...
        try {
            const res = await (0, user_content_service_1.getBrowseHistoryList)(1, this.data.pageSize);
            if (!res.ok) {
    ...
    async loadMore() {
        ...
        try {
            ...
            const res = await (0, user_content_service_1.getBrowseHistoryList)(next, this.data.pageSize);
            if (!res.ok) {
