...
Page({
    ...
    async loadFirstPage(fromRefresh = false) {
        ...
        try {
            const res = await (0, user_content_service_1.getMyLikedList)(1, this.data.pageSize);
            if (!res.ok) {
    ...
    async loadMore() {
        ...
        try {
            ...
            const res = await (0, user_content_service_1.getMyLikedList)(next, this.data.pageSize);
            if (!res.ok) {
