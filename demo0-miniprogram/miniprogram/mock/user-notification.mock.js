...
exports.MOCK_UNREAD_COUNT = exports.MOCK_NOTIFICATION_LIST = exports.MOCK_USER_INFO = void 0;
exports.getMockNotificationUnreadCount = getMockNotificationUnreadCount;
/**
 * 我的页 mock 用户；联调前可改字段验收缺省与展示。
 * 未读角标由 `getMockNotificationUnreadCount()` 根据通知列表 `isRead` 动态计算。
 */
exports.MOCK_USER_INFO = {
    userId: 98009,
    nickname: '演示用户（Mock）',
    nickName: '演示用户（Mock）',
    avatarUrl: '',
...
exports.MOCK_NOTIFICATION_LIST = [
    {
        id: 501,
        type: 'LIKE_CONTENT',
        typeDesc: '赞了你的内容',
 ...
 */
exports.MOCK_UNREAD_COUNT = 6;
/** Mock 未读数：与列表 `isRead` 联动，供自定义 TabBar 与通知页验收 */
function getMockNotificationUnreadCount() {
    return exports.MOCK_NOTIFICATION_LIST.reduce((n, x) => n + (x.isRead === 1 ? 0 : 1), 0);
}
