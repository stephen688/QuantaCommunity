 ...
 */
export const LOCAL_BASE_URL = 'http://127.0.0.1:9191';

/** 真机 / 体验版联调公网地址（ngrok 等）；重启 ngrok 后只改这一处 */
export const REMOTE_BASE_URL = 'https://quintuple-paprika-kilt.ngrok-free.dev';

/**
 * 开发者工具是否也走 REMOTE_BASE_URL（ngrok）。
 * 为 true 时：改 ngrok 后开发者工具与真机打同一后端；本机 9191 未起或未重新编译时也能联调。
 */
export const DEVTOOLS_USE_REMOTE = false;
 ...
 * 联调/提审前务必改为 false。
 */
export const DEV_CLEAR_TOKEN_ON_LAUNCH = false;
 ...
 */
export const DEV_LOGIN_CODE = 'test';
