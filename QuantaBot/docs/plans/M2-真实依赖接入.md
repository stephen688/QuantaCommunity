...
- [x] **Step 1.4：跑测试确认通过 + .env.example 增补**
...
- [x] **Step 6.4：跑测试确认通过（含 M1 集成用例演进）+ 三件套 + 提交**
...
- [x] **Step 11.1：写 .dockerignore 与 Dockerfile**
...
- [x] **Step 11.2：写 docker-compose.yml**
...
- [x] **Step 11.3：vendored Langfuse 官方 compose**
...
- [x] **Step 12.1：pytest 配置 + conftest 门禁**
...
- [x] **Step 12.2：写四个 integration 测试文件**
...
- [x] **Step 13.2：独立审查（requesting-code-review skill，派 reviewer 子代理）**
...
- [x] **Step 13.3：push（获管理员授权后）+ CI 绿 + 合并**
...
- [x] **Step 13.4：总计划/技术选型/AGENTS 回写**
