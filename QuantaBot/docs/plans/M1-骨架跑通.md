...
- [ ] **Step 0.1：从 main 切 M1 功能分支并提交本计划**
...
- [ ] **Step 1.2：写失败的测试（RED——audit_db_path 默认值与覆盖）**
...
- [ ] **Step 6.1：写失败的测试（RED——全链路集成用例 = 总计划 M1 三条验收 + trigger 检测）**
...
- [ ] **Step 7.1：ci.yml 增 timeout 与 concurrency**
...
- [ ] **Step 9.2：独立审查（requesting-code-review skill，派 reviewer 子代理）**
